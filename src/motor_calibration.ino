...
void loop() {
    ...
    Serial.println("GET READY IN 10 SECONDS - MOTOR LEFT PIN 10");
    delay(7000);
    Serial.println("GET READY IN 3 SECONDS - MOTOR LEFT PIN 10");
    delay(3000);
    ...
    Serial.println("GET READY IN 10 SECONDS - MOTOR RIGHT PIN 11");
    delay(7000);
    Serial.println("GET READY IN 3 SECONDS - MOTOR R PIN 11");
    delay(3000);
